    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity http, JwtFilter jwtFilter) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**", "/api/locations", "/api/hotels", "/api/hotels/**",
                                "/api/tours", "/api/tours/**", "/api/flights", "/api/flights/**",
                                "/api/bus-trips", "/api/bus-trips/**", "/api/providers/*/reviews").permitAll()
                        .requestMatchers("/api/users/me", "/api/bookings/**", "/api/payments/**",
                                "/api/provider/**").authenticated()
